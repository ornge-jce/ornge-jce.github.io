...
$image = get_the_post_thumbnail_url( get_the_ID(), 'oblo_900x900' );
$image_full = get_the_post_thumbnail_url( get_the_ID(), 'oblo_1920xAuto' );
$title = get_the_title();

?>

<div class="works-col col-xs-12 col-sm-6 col-md-6 col-lg-4 <?php echo esc_attr( $categories_slugs_string ); ?>">
	<div class="works-item scrolla-element-anim-1 scroll-animate" data-animate="active">
		<a data-elementor-open-lightbox="yes" data-elementor-lightbox-slideshow="basic-portfolio-gallery" data-elementor-lightbox-title="<?php echo esc_attr( $title ); ?>" href="<?php echo esc_url( $image_full ); ?>">
			<?php if ( $image ) : ?>
			<span class="image">
				<span class="img">
